...
(function () {
    ...
    // sees "otpAccounts" in STORE_NAMES) creates the new object store
    // for the CozyOS Authenticator's persisted accounts. Existing
    ...
    if (window.CozyOS.ServiceRegistry && typeof window.CozyOS.ServiceRegistry.registerCoordinator === "function") {
        try {
            window.CozyOS.ServiceRegistry.registerCoordinator({ sourcePath: "core/modules/identity/identity-storage.js",
