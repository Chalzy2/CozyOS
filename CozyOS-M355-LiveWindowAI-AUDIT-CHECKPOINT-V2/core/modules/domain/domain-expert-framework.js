...
(function () {
    ...
    })({ sourcePath: "core/modules/domain/domain-expert-framework.js", name: "DomainExpertFramework", category: "Code Generation", icon: "domain-expert.svg", description: "Real, curated domain checklists (Church/Quarry/Power populated; Healthcare/Education/Finance/Logistics real-but-empty) extending RequirementAnalyzer's gap detection." });
})();
