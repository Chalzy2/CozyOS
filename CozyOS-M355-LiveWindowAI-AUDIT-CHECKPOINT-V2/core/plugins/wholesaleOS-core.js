    ...
    if (window.CozyOS.ServiceRegistry && typeof window.CozyOS.ServiceRegistry.registerApplication === "function") {
        try {
            window.CozyOS.ServiceRegistry.registerApplication({
                ...
                // all - see applications/WholesaleOS/wholesaleos.html's
                // own header for the real, minimal Phase 1 destination
                // this now resolves to (the same real getSharedCatalog()
                // this file already implements, no new capability).
                entryPoint: "applications/WholesaleOS/wholesaleos.html", launcher: "core/plugins/wholesaleOS-core.js",
        ...
        try {
            window.CozyOS.ServiceRegistry.registerCoordinator({ sourcePath: "core/plugins/wholesaleOS-core.js",
