    ...
    if (window.CozyOS.ServiceRegistry && typeof window.CozyOS.ServiceRegistry.registerApplication === "function") {
        try {
            window.CozyOS.ServiceRegistry.registerApplication({
                ...
                launcher: "core/plugins/mpesaOS-engine.js", entryPoint: "applications/MpesaOS/index.html",
                sourcePath: "core/plugins/mpesaOS-engine.js", certificationStatus: "NOT_CERTIFIED"
            });
