...
(function () {
    ...
    })({ sourcePath: "core/modules/planning/planning-engine.js", name: "PlanningEngine", category: "Foundation", icon: "planning.svg", description: "Real dependency-gated recommendation + unlock-count ranking + WHY-NOT explanations + Developer Decision Memory. Business value/cost/revenue honestly not computed." });
})();
