...
`;
    ...
    class CozyOSDeveloperHub {
        ...
        registerToServiceRegistry(moduleId) {
            ...
            const result = registry.registerCoordinator({ sourcePath: "core/modules/developer/cozy-developer.js", name: moduleId, category: "Business Domain", icon: `${moduleId.toLowerCase()}.svg`, description: `${moduleId} — registered from Developer Hub.` });
