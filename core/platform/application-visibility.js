...
(function () {
    ...
    class CozyApplicationVisibility {
         ...
         *   keeping their own copy. Confirmed via direct file listing,
         *   not guessed - MpesaOS is intentionally absent (honestly
         *   "Development" status, `hasLauncher` false regardless).
         */
        getRealLaunchPath(appId) {
            const REAL_APP_PATHS = { shopos: "applications/ShopOS/shopos.html", quarry_manager_001: "applications/QuarryOS/quarry.html" };
            return REAL_APP_PATHS[appId] || null;
        }
