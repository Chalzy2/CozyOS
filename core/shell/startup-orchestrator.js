...
(function () {
    ...
    const DEFAULT_CONFIG = Object.freeze({
        ...
        preRevealDelayMs: 500,         // M355: matches the approved timeline's Stage 1 (0.00-0.50s pure emerald, no white flash) before Stage 2 begins
        audioEnabled: true,
        audioFadeMs: 1500,
        soundsEnabled: true
    });
    ...
    class CozyStartupOrchestrator {
        ...
        async playStartupAmbience() {
            ...
            const layers = [
                { name: "ambience-wind", volume: 0.25 },
                { name: "ambience-birds", volume: 0.40 },
                { name: "ambience-forest", volume: 0.18 },
            ];
