            ...
            container.querySelector("#cozy-login-credentials-form").addEventListener("submit", async (e) => {
                ...
                try {
                    ...
                    if (result.requiresOtp) {
                        ...
                        // This gate does not implement its own OTP UI;
                        // honestly disclose rather than silently stall.
                        showError(container, "This account requires a verification code. Please complete sign-in via the main login page.");
                        return;
                    }
