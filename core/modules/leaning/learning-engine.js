...
(function () {
    ...
    })({ sourcePath: "core/modules/leaning/learning-engine.js", name: "LearningEngine", category: "Code Generation", icon: "learning.svg", description: "Thin orchestration over UnderstandingEngine's real pattern lifecycle — never duplicates storage, never bypasses the existing certification+audit gate." });
})();
