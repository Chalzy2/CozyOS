...
(function () {
    ...
    })({ sourcePath: "core/modules/builder/architecture-engine.js", name: "ArchitectureEngine", category: "Code Generation", icon: "architecture-engine.svg", description: "Real deterministic blueprint generation from RequirementAnalyzer output — module list, folder structure, data model." });
})();
