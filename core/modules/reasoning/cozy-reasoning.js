...
(function () {
    ...
    class CozyReasoningEngine {
        ...
        reason({ evidence, interpretationsUsed = [], thinkingResults = [], type = "evidence-based", ruleContext = {}, providerId = null, sessionId = null } = {}) {
            ...
            let raw;
            try { raw = provider.fn({ evidence, interpretationsUsed, thinkingResults, type, rulesApplied }); }
            catch (err) {
