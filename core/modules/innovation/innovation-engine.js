...
(function () {
    ...
    })({ sourcePath: "core/modules/innovation/innovation-engine.js", name: "InnovationEngine", category: "Code Generation", icon: "innovation.svg", description: "Real cross-domain pattern/duplicate detection and reuse recommendations over CozyMemory/UnderstandingEngine. No fabricated creativity." });
})();
