...
(function () {
    ...
    class CozyCognitiveCoordinator {
        ...
        /**
         * run({ text, actorId, memoryNamespace, category })
         ...
         */
        async run({ text, actorId = "system", memoryNamespace = "cognitive-default", category = "custom", conversationId = null } = {}) {
            ...
            if (!interpretation) {
                ...
                interpretationResult = interpretation.interpret({ sourceType: "custom", evidence });
            ...
            if (!thinking) {
                ...
                thinkingResult = thinking.think({ evidence, interpretationsUsed });
            ...
            if (!reasoning) {
                ...
                reasoningResult = reasoning.reason({ evidence, interpretationsUsed, thinkingResults });
