...
(function () {
    ...
    const IDENTITY_STORAGE_VERSION = "1.1.0-ENTERPRISE";
    ...
    // other 4 real stores.
    const DB_VERSION = 8; // M387 — bumped again for the new "decisionHistory" store (Living Decision Engine's decision + outcome history)
    const STORE_NAMES = Object.freeze(["users", "trustedDevices", "recoveryQuestions", "recoveryPhrases", "otpAccounts", "deviceKeys", "vaultItems", "trustScores", "behaviorProfiles", "deviceProfiles", "decisionHistory"]);
