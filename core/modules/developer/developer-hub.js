    ...
    class CozyDeveloperHubUI {
        ...
        async #hubBuildPlan(forceGenerate = false) {
            ...
            try {
                ...
                // SAME file rather than generating a new one.
        ...
        #bindEvents() {
            ...
            this.#root.addEventListener("dragover", (evt) => {
                const zone = evt.target.closest("#cz-hub-qc-dropzone, #cz-hub-builder-dropzone, #cz-hub-refactor-dropzone");
            ...
            this.#root.addEventListener("drop", (evt) => {
                ...
                if (!qcZone && !builderZone && !refactorZone) return;
                evt.preventDefault();
                (qcZone || builderZone || refactorZone).classList.remove("cz-dropzone-active");
