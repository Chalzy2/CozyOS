                ...
                <div class="cz-panel">
                    ...
                    <div class="cz-field"><label>Method 3 — Upload existing file(s)</label>
                        <div class="cz-dropzone" id="cz-hub-builder-dropzone">
                            <p>Drag &amp; drop file(s) here (.js, .html, .css, .json, .md, .txt) — multiple files supported — or use the picker below. The first file's content loads directly into Method 2's editor above.</p>
                ...
                <div class="cz-panel">
                    ...
                    <div class="cz-field"><label>Method 3 — Upload existing file(s)</label>
                        <div class="cz-dropzone" id="cz-hub-bugfixer-dropzone">
                            ...
                            <input type="file" id="cz-hub-bugfixer-files" accept=".js,.html,.css,.json,.md,.txt" multiple />
                        </div>
                    </div>
