...
(function () {
    ...
    })({ sourcePath: "core/modules/policy/policy-engine.js", name: "PolicyEngine", category: "Foundation", icon: "policy.svg", description: "Real versioned policy/governance registry with approval workflow and enforcement against caller-supplied real data (e.g. Certification verdicts)." });
})();
