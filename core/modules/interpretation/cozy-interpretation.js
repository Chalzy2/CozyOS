...
(function () {
    ...
    class CozyInterpretationEngine {
         ...
         */
        async interpret({ sourceType, evidence, context = {}, providerId = null, sessionId = null } = {}) {
            ...
            let raw;
            try { raw = await provider.fn(evidenceRecords, assembledContext); }
            catch (err) {
    ...
    if (window.CozyOS.ServiceRegistry && typeof window.CozyOS.ServiceRegistry.registerCoordinator === "function") {
        try {
            window.CozyOS.ServiceRegistry.registerCoordinator({ sourcePath: "core/modules/interpretation/cozy-interpretation.js",
