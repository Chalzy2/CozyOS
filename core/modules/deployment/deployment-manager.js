...
(function () {
    ...
    })({ sourcePath: "core/modules/deployment/deployment-manager.js", name: "DeploymentManager", category: "Foundation", icon: "deployment.svg", description: "Provider-based Deployment Manager — real 8-method DeploymentProvider interface. Local Workspace fully operational; GitHub/GitLab/Cloudflare Pages/Firebase/Netlify/Local Folder architecturally complete, honestly Not Configured." });
})();
