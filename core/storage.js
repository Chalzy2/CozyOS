 ...
 * F-12 [Medium]    BusinessRecordEngine milestone: added "business_records" and
 *                   "business_record_schemas" stores (smallest additive config
...
const STORE_PERMISSIONS = {
    ...
    businessos:  new Set(["products","inventory","orders","payments","wallet","customers",
                          ...
                          "business_records","business_record_schemas"]),
