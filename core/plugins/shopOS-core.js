    ...
    if (window.CozyOS.ServiceRegistry && typeof window.CozyOS.ServiceRegistry.registerApplication === "function") {
        try {
            window.CozyOS.ServiceRegistry.registerApplication({
                ...
                launcher: "core/plugins/shopOS-core.js", entryPoint: "applications/ShopOS/shopos.html",
                sourcePath: "core/plugins/shopOS-core.js", certificationStatus: "NOT_CERTIFIED"
            });
    ...
    function initRegistration() {
        ...
        if (window.CozyOS && window.CozyOS.PluginManager) {
            window.CozyOS.PluginManager.register(
                ...
                window.CozyOS.PluginManager.createMinimalIntentHandler(engineInstance, "ShopOS")
            );
        } else {
